...
export const columns = [
    { title: '交易ID', dataIndex: 'tx_id', ellipsis: true },
    { title: '发起人', dataIndex: 'username', ellipsis: true },
    { title: '状态', dataIndex: 'status', width: 300, align: 'center' },
    //{ title: '合约', dataIndex: 'contract', width: 90, align: 'center' },
    //{ title: '起始链', dataIndex: 'from', ellipsis: true },
    //{ title: '目的链', dataIndex: 'to', ellipsis: true },
    //{ title: '跨链方式', dataIndex: 'type', width: 120, align: 'center' },
