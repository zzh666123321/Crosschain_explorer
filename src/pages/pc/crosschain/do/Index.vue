      ...
      <div v-if="isPopupVisible" class="popup" @keydown.esc="hidePopup" tabindex="0">
        <div class="popup-content">
          ...
          <div class="input-container">
            <label for="textInput">输入参数:</label>
            <el-input v-model="textInput" id="textInput" placeholder="输入参数"></el-input>
          </div>

          <div class="spacer"></div>
          <div class="button-container">
            <el-button type="primary" @click="execute">执行</el-button>
            <el-button type="primary" @click="hidePopup">关闭</el-button>
...
export default {
  ...
  setup() {
    ...
    const textInput = ref(''); // 添加textInput变量
